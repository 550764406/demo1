<template>
	<div class="ratingselect">
		<div class="rating-type">
			<span @click="select(2,$event)" class="block positive" :class="{'active': selectType2 === 2}">{{desc.all}}
		...
		<div class="switch" @click="toggleContent" :class="{'on': this.onlyContent2}">
			<i class="icon-check_circle"></i>
			<div class="text">只看有内容评论</div>
		</div>
	</div>
</template>
